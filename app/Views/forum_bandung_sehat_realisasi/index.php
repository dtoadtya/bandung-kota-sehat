...
<div class="kelembagaan-header">
    <div>
        ...
        <p>Kelola data realisasi kegiatan Forum Bandung Sehat.</p>
    </div>
...
<div class="kelembagaan-card">
    ...
    <div class="kelembagaan-card-header">
        ...
        <div class="flex-grow-1">
            <h2>Data Realisasi Kegiatan</h2>
            <p>
                Daftar laporan realisasi kegiatan dan pendanaan Forum Bandung Sehat.
            </p>
        </div>

        <a
            href="<?= site_url('forum-bandung-sehat/realisasi/create') ?>"
            class="btn-tambah"
        >
    ...
    <?php if (empty($data)): ?>
        ...
        <div class="empty-state">
            ...
            <h5>Belum ada data realisasi kegiatan</h5>
                ...
                <tbody>
                    <?php foreach ($data as $index => $row): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($row['waktu_kegiatan'])): ?>
                            ...
                            <td>
                                Rp <?= number_format((float) ($row['anggaran'] ?? 0), 0, ',', '.') ?>
                            </td>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <a
                                        href="<?= site_url('forum-bandung-sehat/realisasi/edit/' . $row['id']) ?>"
                                    ...
                                    <form
                                        action="<?= site_url('forum-bandung-sehat/realisasi/delete/' . $row['id']) ?>"
                                        method="post"
