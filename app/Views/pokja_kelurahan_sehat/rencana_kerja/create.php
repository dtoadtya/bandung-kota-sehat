...
<head>
    ...
    <title>Tambah Rencana Kerja Pokja Kelurahan Sehat</title>
...
<div class="content">
    ...
    <header class="top-header">
        ...
        <div class="page-title">
            Tambah Rencana Kerja Pokja Kelurahan Sehat
        </div>
    ...
    <main class="main">
        ...
        <section class="hero">
            ...
            <p class="hero-description">
                Tambahkan rencana kerja Pokja Kelurahan Sehat berdasarkan tahun.
            </p>
        ...
        <section class="form-card">
            ...
            <div class="form-header">
                ...
                <p class="form-description">
                    Silakan isi tahun dan uraian rencana kerja Pokja Kelurahan Sehat.
                </p>
            ...
            <form
                action="<?= base_url('pokja-kelurahan-sehat/rencana-kerja/store') ?>"
                method="post"
            >
                ...
                <div class="form-group">
                    ...
                    <div class="help-text">
                        Pilih kelurahan yang memiliki rencana kerja.
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="help-text">
                        Masukkan tahun dalam format 4 angka, contoh 2026.
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea
                        name="nama_kegiatan"
                        placeholder="Tuliskan rencana kerja berdasarkan tahun..."
                        required
                    ><?= old('nama_kegiatan') ?></textarea>

                    <div class="help-text">
                        Isi uraian rencana kerja, target kegiatan, jadwal,
                        indikator, atau informasi pendukung lainnya.
                    </div>
