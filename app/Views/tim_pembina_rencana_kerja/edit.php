...
<div class="page-wrapper">
    ...
    <div class="page-header">
        ...
        <p>
            Perbarui data rencana kerja Tim Pembina.
        </p>
    ...
    <div class="tahun-card">
        ...
        <div class="tahun-buttons">
            ...
            <a href="<?= base_url('tim-pembina/rencana-kerja?tahun=1') ?>"
               class="btn-tahun <?= ($data['tahun'] ?? '') == '1' ? 'active' : '' ?>">
                ▣ &nbsp; Tahun 1
            </a>

            <a href="<?= base_url('tim-pembina/rencana-kerja?tahun=2') ?>"
               class="btn-tahun <?= ($data['tahun'] ?? '') == '2' ? 'active' : '' ?>">
                ▣ &nbsp; Tahun 2
            </a>
    ...
    <div class="form-card">
        ...
        <div class="form-body">
            ...
            <form action="<?= base_url('tim-pembina/rencana-kerja/update/' . $data['id']) ?>"
                  method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               name="peserta"
                               value="<?= old('peserta', $data['peserta'] ?? '') ?>"
                ...
                <div class="form-group">
                    ...
                    <textarea name="hasil_pelaksanaan"
                              placeholder="Tuliskan hasil pelaksanaan kegiatan..."><?= old('hasil_pelaksanaan', $data['hasil_pelaksanaan'] ?? '') ?></textarea>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        $nilaiAnggaran = $data['anggaran'] ?? '';
                        if ($nilaiAnggaran !== '') {
                            $nilaiAnggaran = number_format(
                                (int) preg_replace('/\D/', '', (string) $nilaiAnggaran),
                                0,
                                ',',
                                '.'
                            );
                        ...
                        <input type="text"
                               name="anggaran"
                               id="anggaran"
                               value="<?= old('anggaran', $nilaiAnggaran) ?>"
